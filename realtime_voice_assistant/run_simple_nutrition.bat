@echo off
echo Simple Nutrition Voice Assistant
echo ================================
echo.
...
py simple_nutrition_app.py --model "vosk-model-small-en-us-0.15\vosk-model-small-en-us-0.15" --list-devices
echo.
...
echo.
echo Starting Simple Nutrition Assistant with device %device_index%...
echo Say 'stop listening' to exit.
echo.

REM Run the nutrition assistant
py simple_nutrition_app.py --model "vosk-model-small-en-us-0.15\vosk-model-small-en-us-0.15" --nutrition-kb "models\nutrition_kb.json" --device %device_index%
